...
export default ({ module: { services = [], tests = [], tasks = [], name, type, description } }: ModuleProp) => {
  const {
    state: {
      overview: { filters },
    },
        ...
        {tests.map((test) => (
          <EntityCard key={test.name} entity={test} type={"test"}>
            <Fields visible={filters.testsInfo}>
              ...
              <FieldGroup className="row between-xs middle-xs" visible={!!test.startedAt}>
        ...
        {tasks.map((task) => (
          <EntityCard key={task.name} entity={task} type={"task"}>
            <Fields visible={filters.tasksInfo}>
              ...
              <FieldGroup className="row between-xs middle-xs" visible={!!task.startedAt}>
